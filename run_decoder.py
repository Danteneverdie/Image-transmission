...
def main():
    ...
    plt.plot(bitrates, psnrs, marker='o', linestyle='-', color='r',
             linewidth=2, label="R-D Curve")
    ...
    plt.title('Rate-Distortion (R-D) Curve', fontsize=16)
    plt.xlabel('Rate (bits/pixel, bpp)', fontsize=16)
    ...
    print("R-D curve saved as 'RD_Curve.png'")
